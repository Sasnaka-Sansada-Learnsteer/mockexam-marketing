...
const ExamCenter = () => {
  ...
  const examCenters = [
    {
      provinceKey: "examCenters.centers.0.province",
      venueKey: "examCenters.centers.0.venue",
      mapUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7921.805930042093!2d79.85647084578099!3d6.902206909028085!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25963120b1509%3A0x2db2c18a68712863!2sUniversity%20of%20Colombo%20School%20of%20Computing%20(UCSC)!5e0!3m2!1sen!2slk!4v1753535419952!5m2!1sen!2slk",
      directionsUrl: "https://www.google.com/maps/dir/?api=1&destination=University+of+Colombo",
    },
    {
      provinceKey: "examCenters.centers.1.province",
      venueKey: "examCenters.centers.1.venue",
    ...
    {
      provinceKey: "examCenters.centers.2.province",
      venueKey: "examCenters.centers.2.venue",
  ...
  return (
      <section className="province-table">
        <div className="container">
          <h2>{t('examCenters.title')}</h2>

          <div className="provincetable-row">
            {examCenters.map((exam, index) => (
                <div
                ...
                >
                  <div className="province-card-header">
                    <h3>{t(exam.provinceKey)}</h3>
                  </div>
                  <div className="province-card-body">
                    <div className="province-detail">
                      <span className="detail-label">{t('examCenters.venueLabel')}</span>
                      <span className="detail-value">{t(exam.venueKey)}</span>
                    </div>
                    <div className="province-map">
                      ...
                      >
                        {t('examCenters.directionsButton')}
                      </a>
                    </div>
                  </div>
                </div>
